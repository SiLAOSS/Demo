namespace SiLA.Provider
{
    ...
    public static class SiLAWebMethodDescriptions
    {
        ...
        public const string AbortDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\"" +
                                ...
                                "<b>requestId</b> parameter is the unique identification of this command call. " +
                                "</Parameter>" +
                                "<Parameter name=\"lockId\" >" +
                                "<b>lockId</b> parameter is the identification of the PMS which has locked" +
                                "the device." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
                                "<Description><i> Empty response.</i></Description>" +
                                "</Response>" +
        ...
        public const string GetDeviceIdentificationDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\"" +
                                ...
                                "<b> deviceDescription</b> is the Device Identification. It is a SOAP complex type." +
                                "</Parameter>" +
                                "</SiLACommandDescription>";
        ...
        public const string GetStatusDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\"" +
                                ...
                                "<b> deviceId</b> is the identification the device returns to identify itself at the PMS." +
                                "</Parameter>" +
                                "<Parameter name=\"state\">" +
                                "<b> state</b> is the status of the device" +
                                "</Parameter>" +
                                "<Parameter name=\"subStates\">" +
                                "<b> subStates</b> is the substate of the above state." +
                                "</Parameter>" +
                                "<Parameter name=\"locked\">" +
                                "<b> locked</b> is the lock state of the device (locked=true, unlocked = false)" +
                                "</Parameter>" +
                                "<Parameter name=\"PMSId\">" +
                                "<b> PMSId</b> is the identification of the PMS that locked the device." +
                                "</Parameter>" +
                                "<Parameter name=\"currentTime\">" +
                                "<b> currentTime</b> is the time of reporting status information." +
                                "</Parameter>" +
                                "</SiLACommandDescription>";
        ...
        public const string LockDeviceDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\"" +
                                ...
                                "</Parameter>" +
                                "<Parameter name=\"lockId\" >" +
                                "<b> lockId</b> parameter hands over the lock identification of the PMS to the device. The device will only accept further commands, if they use the same lockId." +
                                "</Parameter>" +
                                "<Parameter name=\"lockTimeout\" xsi:type=\"Duration\">" +
                                "<b> lockTimeout</b> if this parameter is omitted, no timeout will be set. Otherwise" +
                                ...
                                "<b> eventReceiverURI</b> is the service URI of the Service Consumer’s event Receiver (used in case of timeout that will issue a reset with it)." +
                                "</Parameter>" +
                                "<Parameter name=\"PMSId\" >" +
                                "<b> PMSId</b> is the Id of the PMS in order to identify the PMS that locked a device." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
                                "<Description><i> Empty response.</i></Description>" +
                                "</Response>" +
        ...
        public const string ResetDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\"" +
                                ...
                                "</Parameter>" +
                                "<Parameter name=\"eventReceiverURI\" >" +
                                "<b> eventReceiverURI</b> is the connection information of the Service Consumers event Receiver." +
                                "</Parameter>" +
                                "<Parameter name=\"PMSId\" >" +
                                "<b> PMSId</b> is the Id of the PMS in order to identify the PMS that locked a device." +
                                "</Parameter>" +
                                "<Parameter name=\"errorHandlingTimeout\" xsi:type=\"Duration\">" +
                                "<b> errorHandlingTimeout</b> is the timeout until an errorhandling state is changed into an error state." +
                                "</Parameter>" +
                                "<Parameter name=\"simulationMode\" >" +
                                "<b> simulationMode</b> selects simulation mode." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
                                "<Description><i> Empty response.</i></Description>" +
                                "</Response>" +
        ...
        public const string DelayDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\">" +
                                ...
                                "<Parameter name=\"requestId\" minValue=\"1\" maxValue=\"2147483647\"><b> requestId</b> parameter is the unique identification of this command call." +
                                "</Parameter>" +
                                "<Parameter name=\"lockId\"><b> lockId</b> parameter is the identification of the SiLA Service Consumer, which has locked the device." +
                                "</Parameter>" +
                                "<Parameter name=\"duration\"><b> duration</b> parameter defines suspend duration." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
                                "<Description><i> Empty response.</i></Description>" +
                                "</Response>" +
        ...
        public const string GetParametersDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\">" +
                                ...
                                "<Description>" +
                                "<i> Returns the parameter set of the device as parameterName, value pair.</i>" +
                                "</Description>" +
                                "</Response>" +
                                "</SiLACommandDescription>";
        ...
        public const string SetParametersDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\">" +
                                ...
                                "The xml Document of <b>paramsXML</b> is formatted as stated in the ParameterSet tag." +
                                "<ParameterSet>" +
                                "</ParameterSet>" +
                                "</Parameter>" +
                                "</SiLACommandDescription>";
        ...
        public const string StoreAtPositionDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\">" +
                                ...
                                "</Summary>" +
                                "<Parameter name=\"requestId\" minValue=\"1\" maxValue=\"2147483647\"><b> requestId</b> parameter is the unique identification of this command call." +
                                "<Parameter name=\"lockId\"><b> lockId</b> parameter is the identification of the PMS, which has locked the device." +
                                "</Parameter>" +
                                "<Parameter name=\"position\"> The <b>position</b> parameter is used to specify at which position the labware shall be stored." +
                                "</Parameter>" +
                                "<Parameter name=\"labwareType\"> The <b>labwareType</b> parameter may be used to transfer information about the labware that the device might need to access it correctly." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
                                "<Description><i> Empty response.</i></Description>" +
                                "</Response>" +
        ...
        public const string RetrieveByPositionIdDescription = "<SiLACommandDescription isCommonCommand=\"true\" estimatedDuration=\"PT0S\">" +
                                ...
                                "</Summary>" +
                                "<Parameter name=\"requestId\" minValue=\"1\" maxValue=\"2147483647\"><b> requestId</b> parameter is the unique identification of this command call." +
                                "<Parameter name=\"lockId\"><b> requestId</b> parameter is the identification of the PMS, which has locked the device." +
                                "</Parameter>" +
                                "<Parameter name=\"position\"> The <b>position</b> parameter is used to specify which labware item shall be retrieved." +
                                "</Parameter>" +
                                "<Parameter name=\"labwareType\"> The <b>labwareType</b> parameter may be used to transfer information about the labware that the device might need to access it correctly." +
                                "</Parameter>" +
                                "<Response xsi:type=\"standardResponse\" parameterSetCount=\"0\">" +
